...
namespace Mebs_Envanter
{
    class EmptyClass
    {       
        //String conString = "Select * From tbl_bilgisayar pc " +
        //      "left outer join tbl_bagli_ag ag on pc.bagli_ag_id = ag.bagli_ag_id";
        
         //<!--<TabControl Grid.Column="2" x:Name="pcEnvanterTabControl"
             //       DataContext="{Binding ElementName=pcList,Path=SelectedItem}"
           //         >-->
        ...
        //<TabControl Visibility="Collapsed" Grid.Column="2" x:Name="pcEnvanterTabControl">
        //    <TabControl.Resources>
        //        <Style TargetType="{x:Type Border}">
        //            <Setter Property="Background">
        //                <Setter.Value>
        //                    <LinearGradientBrush  StartPoint="0,0" EndPoint="0,1" >
        //                        <GradientStop Color="#FF638CB7" Offset="0" />
        //                        <GradientStop Color="#FF71AA98" Offset="1" />
        //                    </LinearGradientBrush>
        //                </Setter.Value>
        //            </Setter>
        ...
        //    <TabItem Header="Monitor" x:Name="monitorTab" DataContext="{Binding MonitorInfo}">
        //        <Border >
        ...
        //    <TabItem Header="Senet" x:Name="senetTab" DataContext="{Binding Senet}">
        //        <Border >
        ...
        //    <TabItem Header="Ağ Bilgileri" x:Name="networkTab" DataContext="{Binding NetworkInfo}">
        //        <Border >
        //            <hardwareusercontrols:NetworkInfoUserControl x:Name="networkUserControl1">
