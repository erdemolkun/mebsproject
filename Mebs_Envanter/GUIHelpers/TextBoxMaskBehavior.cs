...
namespace MEBS_Envanter
{
    ...
    public class TextBoxMaskBehavior
    {
        ...
        #region SetValuesMinMaxOnOverflo Property

        public static void SetSetValuesMinMaxOnOverflow(DependencyObject obj, bool value)
        {
            obj.SetValue(SetValuesMinMaxOnOverflowProperty, value);
        }
        public static bool GetSetValuesMinMaxOnOverflow(DependencyObject obj)
        {
            return (bool)obj.GetValue(SetValuesMinMaxOnOverflowProperty);
        }

        public static readonly DependencyProperty SetValuesMinMaxOnOverflowProperty =
           DependencyProperty.RegisterAttached(
               "SetValuesMinMaxOnOverflow",
               typeof(bool),
               typeof(TextBoxMaskBehavior),
        ...
        //static TextBoxMaskBehavior()
        //{
        //    try
        //    {
        //        SetValuesMinMaxOnOverflowProperty = SetValuesMinMaxOnOverflowProperty =
        //   DependencyProperty.RegisterAttached(
        //       "SetValuesMinMaxOnOverflow",
        //       typeof(bool),
        //       typeof(TextBoxMaskBehavior),
        ...
        private static void TextBox_PreviewTextInput(object sender, System.Windows.Input.TextCompositionEventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                if (_this.MaxLength<1 || text.Length <= _this.MaxLength)
                {
                    _this.Text = text;
