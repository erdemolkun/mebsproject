...
namespace Mebs_Envanter.PrintOperations
{
    internal class SystemPrint
    {
        ...
        void PrintComputer(ComputerInfo computerInfo, PrintPageEventArgs e)
        {
            ...
            GridPrinter p0 = new GridPrinter(new Rectangle(100, 40, 999, 30), xPercantages, yPercantages);
            p0.PaintGrid(e.Graphics);
            ...
            GridPrinter p4 = new GridPrinter(new Rectangle(100, 70, 1000, 50), xPercantages4, yPercantages4);
            p4.PaintGrid(e.Graphics);
            ...
            GridPrinter p3 = new GridPrinter(new Rectangle(100, 120, 1000, 40), xPercantages3, yPercantages3);
            p3.PaintGrid(e.Graphics);
            ...
            */
            ...
            GridPrinter p2 = new GridPrinter(new Rectangle(100, 160, 1000, 500), xPercantages2, yPercantages2);
            p2.PaintGrid(e.Graphics);

            int row = 1;
            foreach (OemDeviceViewModel item in computerInfo.OemDevicesVModel.OemDevicesAll)
            {
                String name = item.ParcaTipiIsmi;
                printOemDeviceProperties(p2, e.Graphics, item.DevOem, row, name, fontSmall);
                row++;

            }
            OemDeviceViewModel x = new OemDeviceViewModel(computerInfo.MonitorInfo);
            printOemDeviceProperties(p2, e.Graphics, x.DevOem, row, "Monitör", fontSmall);
            ...
            */
            ...
            GridPrinter p5 = new GridPrinter(new Rectangle(100, 656, 996, 40), xPercantages5, yPercantages5);
            p5.PaintGrid(e.Graphics);
            ...
            */
            ...
            GridPrinter p6 = new GridPrinter(new Rectangle(100, 697, 1000, 40), xPercantages6, yPercantages6);
            p6.PaintGrid(e.Graphics);
        ...
        void PrintYazici(YaziciInfo yaziciInfo, PrintPageEventArgs e)
        {
            ...
            PointF malzemeyi_veren_data = p4.getlocation(0, 1);
            e.Graphics.DrawString(yaziciInfo.Senet.Veren_kisi_isim, fontSmall,
                                   Brushes.Black, malzemeyi_veren.X, malzemeyi_veren.Y + yaziBoyutu_Malzeme_veren.Height);
            ...
            */
            ...
            PointF ad_soyad_rutbe_Loc2 = p6.getlocation(1, 1);
            e.Graphics.DrawString(yaziciInfo.Senet.Alan_kisi_isim + ", " + yaziciInfo.Senet.Alan_kisi_rutbe, fontSmall,
                                   Brushes.Black, ad_soyad_rutbe_Loc2.X, ad_soyad_rutbe_Loc2.Y);
        ...
        void PrintAnyObject(MebsBaseObject mebsObject, Graphics g)
        {
            ...
            */
            ...
            PointF aciklama_Loc = p5.getlocation(0, 0);
            g.DrawString("AÇIKLAMALAR:", fontMedium,
                                   Brushes.Black, aciklama_Loc.X, aciklama_Loc.Y);
